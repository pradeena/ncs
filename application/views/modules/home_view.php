				...
				<div class="owl-carousel dots-inline" 
					...
					<div class="blog-wrap" style="min-height: 433px;">
						...
						<div class="blog-img-wrap" style="border-bottom: 1px solid #ccc;margin-top: 0px;">
							<img src="<?php echo FILE_PATH; ?>uploads/colleges/thumbs/<?php echo $image; ?>" class="img-responsive center-block" alt="<?php echo $row_college["Clge_name"]; ?>" style="width:138px;height:68px;"> 
			...
			<div class="row">
				...
				<div class="owl-carousel show-nav-hover dots-dark nav-square dots-square navigation-color" data-animatein="zoomIn" data-animateout="slideOutDown" data-items="1" data-margin="30" data-loop="true" data-merge="true" data-nav="true" data-dots="false" data-stagepadding="" data-mobile="1" data-tablet="3" data-desktopsmall="3"  data-desktop="4" data-autoplay="false" data-delay="3000" data-navigation="true"> 
					...
					<div class="blog-wrap" style="background:#F6F6F6;">
						<!-- Blog Image Wrapper -->
						<div class="blog-img-wrap" style="border-bottom: 1px solid #ccc;margin-top: 0px;">
							<img src="<?php echo FILE_PATH; ?>uploads/courses/thumbs/<?php echo $image; ?>" class="img-responsive center-block" alt="<?php echo $row_courses["Course_name"]; ?>" style="width:215px;height:80px;">
			...
			<div class="row"> 
				...
				<div class="col-cd-8 col-sm-8 col-xs-12">
					...
					<div class="owl-carousel dots-inline" 
						...
						<div class="item">
							<a href="<?php echo base_url();?>updates/<?php echo $row["news_id"];?>/<?php echo $url;?>" style="color:#111;"><img class="img-responsive" style="height:140px;" src="<?php echo FILE_PATH; ?>uploads/news-article-event/thumbs/<?php echo $image; ?>" alt="<?php echo $row["content_title"];?>">
